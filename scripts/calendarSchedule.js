...
function render(schedule) {
    if (window.innerWidth < 1300) {
        ...
        for (var i = 0; i < schedule.length; i++) {
            document.write("<thead class='thead-dark calendarTable'><th colspan='5'>" + monthNames[schedule[i].month[0].date.getMonth()] + "</th></thead>");
            for (var j = 0; j < schedule[i].month.length;) {
                document.write("<tr>");
                for (k = 0; k < 5; k++) {
                    document.write("<td>" + schedule[i].month[j].date.toDateString());
                    document.write("<p>" + schedule[i].month[j].lesson + "</p>");
                    document.write("<p>" + schedule[i].month[j].instructor + "</p></td>");
                    j++;
                }
                document.write("</tr>");
            }
    ...
    var completeSchedule = [
        ...
        },
        {
            month: [
                ...
                { date: new Date(2018, 10, 01), lesson: '', instructor: '' },
                { date: new Date(2018, 10, 02), lesson: '', instructor: '' }
        ...
        },
        {
            ...
            month: [
                ...
                { date: new Date(2019, 01, 01), lesson: '', instructor: '' }
            ]
        },
        {
            //February
        ...
        },
        {
            ...
            month: [
                ...
                { date: new Date(2019, 04, 01), lesson: '', instructor: '' },
                { date: new Date(2019, 04, 02), lesson: '', instructor: '' },
                { date: new Date(2019, 04, 03), lesson: '', instructor: '' }
            ]
        },
        {
            // May
            month: [
                ...
                { date: new Date(2019, 04, 11), lesson: '', instructor: '' },
                { date: new Date(2019, 04, 12), lesson: '', instructor: '' }
            ]
        }
    ];
